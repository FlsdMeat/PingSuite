const { graphAPILog } = require('../logging.js')
async function SelectDate(graphData, url,graphParams){
    try {
        ...
        graphAPILog(`Error with SelectDate`,error)
    }
}
function datasetsSelectDateDevices(graphData, graphYAxis, labels, selectDate){
    try {
        ...
        graphAPILog(`Error with SelectDate datasetsSelectDateDevices`,error)
    }
}
function datasetsSelectDateBuildings(graphData,graphYAxis,labels, labelsObj){
    try {
        ...
        graphAPILog(`Error with SelectDate datasetsSelectDateBuildings`,error)
    }
}
